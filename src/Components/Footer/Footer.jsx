...
function Footer() {
	return (
		<div className='footer'>
			<h3>Netflix clone developed with  
				  ~ <svg title='react' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32">
				...
				, by <Link className='footer-link'target='_blank' to={{pathname:'https://github.com/FaizalKhan-AT'}}> Faizal Khan</Link>
			</h3>
		</div>
	)
}
